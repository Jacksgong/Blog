...
> 之前买了一台改过硬件的TP-Link WR841N-V7路由器，并且成功刷机OpenWrt也完成了翻墙，但是可能卖家焊接的有问题，导致老是听到滋滋滋高频率的赤耳声音，很不爽，因此无奈拿起之前的TL-WR720N V3，这台内存小，存储空间小的路由器，倒腾起来，没想到，踩了一天的坑，总算是完美翻墙。
...
进入 服务->ChinaDNS 修改上游服务器为:`223.6.6.6,123.125.81.6,114.114.115.115,114.114.114.114,8.8.4.4,127.0.0.1:5151`，确认本地端口为`5353`。
