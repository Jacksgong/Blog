...
> 之前买了一台改过硬件的TP-Link WR841N-V7路由器，并且成功刷机OpenWrt也完成了翻墙，WR841N-V7的更多详情可以看[这里](http://jacksgong.com/2015/09/05/TP-Link-WR841N-V7-OpenWrt-ShadowSocks/)，但是可能卖家焊接的有问题，导致老是听到滋滋滋高频率的赤耳声音，很不爽，因此无奈拿起之前的TL-WR720N V3，这台内存小，存储空间小的路由器，捣腾起来，没想到，踩了一天的坑，总算是完美翻墙。
